...
import { setTeamName , setTeamDescription , setTeamMode , setTeamMembers } from "../store/slices/teamSlice";
import axios from "axios";
import toast from "react-hot-toast";

const CreateTeamModal = ({ setTeamModal }: { setTeamModal: Function }) => {

  const handleClose = () => {
    dispatch(setTeamMode(false))
    dispatch(setTeamMembers([]))
    dispatch(setTeamDescription(''))
